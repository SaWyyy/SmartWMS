...
namespace SmartWMS.Migrations
{
    ...
    [Migration("20240904162540_change_relation_between_orderHeader_and_waybill")]
    partial class change_relation_between_orderHeader_and_waybill
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartWMS.Models.Product", b =>
                {
                    b.HasOne("SmartWMS.Models.ProductDetail", "ProductDetailsProductDetail")
                        ...
                        .HasForeignKey("SmartWMS.Models.Product", "ProductDetailsProductDetailId")
                        .IsRequired()
            ...
            modelBuilder.Entity("SmartWMS.Models.Waybill", b =>
                {
                    ...
                    b.HasOne("SmartWMS.Models.OrderHeader", "OrderHeadersOrderHeader")
                        .WithOne("WaybillsWaybill")
                        .HasForeignKey("SmartWMS.Models.Waybill", "OrderHeadersOrderHeaderId")
                        .IsRequired()
